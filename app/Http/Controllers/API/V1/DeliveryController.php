...
class DeliveryController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totalRecords = Delivery::select('count(*) as allcount')->count();   // Total records
        $iTotalDisplayRecords = Delivery::select('count(*) as allcount')->search($searchValue)->count();

        // Fetch records
        $records = Delivery::search($searchValue)
