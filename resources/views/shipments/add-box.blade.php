...
@section('title', __('Add Box to Shipment'))

@section('content')
    <x-page-title>@lang('Add Box to Shipment')</x-page-title>
    <x-card>
        <form action="{{ route('shipments.boxes.store', $shipment->id) }}" method="POST" enctype="multipart/form-data" role="form">
            @csrf
            ...
            <div class="mb-3 row">
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" name="box_name" class="form-control @error('box_name') is-invalid @enderror"
                        id="box_name" value="{{ old('box_name') }}">
                    @error('box_name')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="text" name="box_barcode" class="form-control @error('box_barcode') is-invalid @enderror"
                        id="box_barcode" value="{{ old('box_barcode') }}">
                    @error('box_barcode')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="number" name="box_weight" class="form-control @error('box_weight') is-invalid @enderror"
                        id="box_weight" step="0.01" value="{{ old('box_weight') }}">
                    @error('box_weight')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="number" name="box_price" class="form-control @error('box_price') is-invalid @enderror"
                        id="box_price" step="0.01" value="{{ old('box_price') }}">
                    @error('box_price')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="mb-3 row">
                <div class="mb-3 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <input type="number" name="box_shipment_charge"
                        ...
                        step="0.01" value="{{ old('box_shipment_charge') }}">
