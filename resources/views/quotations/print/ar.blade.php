...
<body>
    ...
    <div style="margin: 30px; margin-top: 30px; width:350px">
        <div style="margin-top: 1rem; margin-bottom: 0.2rem;text-align: center !important;">

            @if ($settings->logo)
                <div style="padding-right: 1rem;padding-left: 1rem;margin-bottom: 1rem; width:250px!important">
                    <div style=" width:400px!important">    <img src="{{ asset('images/logo.jpg') }}" style="width:300px" alt="Logo" />
                    </div>
                </div>
            @else
        ...
        <div style="margin-top: 20px;">
            <table style="width: 350px;" class="table1">
                <thead>
                    <tr>
