...
<table class="table table-bordered">
    <thead>
        <tr>
            <th class="fw-bold text-decoration-none">@lang('Category')</th>
            <th class="text-center fw-bold text-decoration-none">@lang('Total Count')</th>
            <th class="text-center fw-bold text-decoration-none">@lang('Total Sales')</th>
        </tr>
    </thead>
    <tbody class="border-top-0">
        @foreach ($sales_category as $sale)
            <tr>
                ...
                <td class="align-middle text-center">{{ $sale->total_qty }}</td>
                <td class="align-middle text-center">{{ currency_format($sale->total_sales) }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
    @foreach ($groupedSales as $categoryId => $categorySales)
    <h5>Category: {{ $categorySales->first()->category_name }}</h5> <!-- Display the category name -->
    <table class="table table-bordered">
        <thead>
            <tr>
